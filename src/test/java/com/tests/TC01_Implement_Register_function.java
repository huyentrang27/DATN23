...
public class TC01_Implement_Register_function extends TestBase {
    ...
    public void TC01(Hashtable<String, String> data) {
        ...
        registerPage.register(logStep, emailAddress, password, password, PID);
        ...
        Assertion.verifyActualAndExpected(logStep, currentURL, RAILWAY_URL);
